...
(defconst *projects-directory*
  (path-join *user-home-directory* "Workspace/projects")
...
(defconst *all-project-directories*
  (list
   *projects-directory*
   (path-join *projects-directory* "paas") ;; you can duplicate or delete this line if you want
   (path-join *projects-directory* "opensource") ;; you can duplicate or delete this line if you want
   (path-join *projects-directory* "personal") ;; you can duplicate or delete this line if you want
   )
